...
instruction_surface = test_font.render('Press  enter  to  start', False, (111, 196, 169))
...
while True:
	...
	if game_active:
		...
		if current_score == 0:
			...
			current_score_surface = test_font.render(f'Score: {current_score}', False, (111, 196, 169))
			current_score_rect = current_score_surface.get_rect(center = (400, 350))
